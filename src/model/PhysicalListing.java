...
public class PhysicalListing extends Listing {
    ...
    public PhysicalListing(String title, String description, double price, ItemCondition condition, ItemCategory category, String sellerId, PickupZone pickupZone, String pickupTime){ 
        super(title, description, price, condition, category, sellerId);
    ...
    public void setPickupZone(PickupZone zone){
